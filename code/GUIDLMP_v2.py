...
This GUI provides a simplified interface to configure and run MNIST-based
distributed deep learning simulations using:
...
class DLMPMainWindow(QMainWindow):
    ...
    def _build_ui(self):
        ...
        self.dataset_value.setStyleSheet(
            "background-color: white; border: 1px solid #808080; padding: 4px;"
        )
        grid.addWidget(self.dataset_value, row, 1)
        row += 1
